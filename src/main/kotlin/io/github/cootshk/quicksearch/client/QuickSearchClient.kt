...
class QuickSearchClient : ClientModInitializer {
    //? if >1.21 {
    val category: KeyMapping.Category = KeyMapping.Category.MISC
    //?} else {
     /*val category: String = KeyMapping.CATEGORY_MISC
    *///?}
    val key: KeyMapping = KeyMapping("key.quicksearch.search", GLFW.GLFW_KEY_N, category)
